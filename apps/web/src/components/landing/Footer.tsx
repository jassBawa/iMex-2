...
const Footer = () => {
  return (
    <footer className="bg-muted/10 py-12 border-t border-border">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            ...
            <span className="text-xl font-bold text-foreground font-dm-sans tracking-tight">
              TradePro
            </span>
          </motion.div>
